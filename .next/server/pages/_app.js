...
// EXTERNAL MODULE: ./context/App/creators.js
var creators = __webpack_require__("bd+2");

// CONCATENATED MODULE: ./context/App/ReducerApp.js
...
/* harmony default export */ var App_ReducerApp = (ReducerApp);
// CONCATENATED MODULE: ./context/App/StateApp.js
const StateApp = () => {
  const state = {
    auth: false,
    user: null
...
/* harmony default export */ var App_StateApp = (StateApp);
...
function MyApp({
  ...
  const {
    0: stateApp,
    1: dispatchApp
  } = Object(external_react_["useReducer"])(App_ReducerApp, App_StateApp());
  return /*#__PURE__*/Object(jsx_runtime_["jsx"])(ContextApp["a" /* default */].Provider, {
    value: {
      stateApp,
      dispatchApp
    },
